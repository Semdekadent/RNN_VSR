...
def main(mode='folder'):
    ...
    if mode == 'folder':
        opt['dataroot_gt'] = 'D:/EDVR/datasets/REDS/train_sharp'
        opt['dataroot_lq'] = 'D:/EDVR/datasets/REDS/train_sharp_bicubic/X4'
        opt['dataroot_flow'] = None
        opt['meta_info_file'] = 'D:/EDVR/basicsr/data/meta_info/meta_info_REDS_GT.txt'
